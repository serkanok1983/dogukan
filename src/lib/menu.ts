...
export const MENU: MenuCategory[] = [
  {
    ...
    items: [
      ...
      { slug: "kaydir-puzzle", label: "Kaydırmalı Bulmaca", emoji: "🧩" },
  ...
  },
  {
    id: "serbest",
    icon: "🧭",
    title: "Serbest Oyunlar · Ebeveynle",
    accent: "#f97316",
    items: [
      { slug: "dovus-arenasi", label: "Refleks Arenası", emoji: "🥋" },
      { slug: "tank-savasi", label: "Tank Labirenti", emoji: "🧱" },
      { slug: "uzayli-istilasi", label: "Uzaylı Savunması", emoji: "👾" },
      { slug: "meyve-bicagi", label: "Meyve Dilimleme", emoji: "🍉" },
      { slug: "kostebek-vur", label: "Köstebek Yakala", emoji: "🐾" },
    ],
  },
  {
    id: "okuma",
